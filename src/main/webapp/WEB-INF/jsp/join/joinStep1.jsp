...
<link rel="stylesheet" href="/css/joinStep1.css">
<!DOCTYPE html>
    <head>
...
<body>
    <form:form id="auth-form" role="form" modelAttribute="joinStep1Command" action="/join/step1" method="post">
        <div id="join-form" class="joinstep1-form">
            ...
            <input type="checkbox" id="join_chk1" path="join_check1"><label for="join_chk1">핑거팡 서비스 이용약관</label></input></br></br>
            <textarea id="join_text1" rows="10" cols="100"> 이하 핑거팡 서비스 이용약관 내용</textarea>
        </br></br></br>
            <input type="checkbox" id="join_chk2" path="join_check2"><label for="join_chk2">개인정보 수집 및 이용 동의</label></br></br></input>
            <textarea id="join_text2" rows="10" cols="100"> 이하 개인정보 수집 및 이용 동의에 관한 내용</textarea>
    </br></br></br>
            
            <a href="/join/step2" class="btn_join_next1" id="next-button">다음 (1/2)</a>
        </div>
