...
<html lang="ko">
	...
	<body>
        ...
        String 
        <!-- Main -->
        <form:form role="form" modelAttribute="joinRequest" action="/join/step3" method="post">
                ...
                <section>
                    ...
                    <form>
                        <div class="row uniform 50%">
                            ...
                            <div class="6u$ 12u$(4)">
                                <input type="text" name="id" id="id" value="" placeholder="아이디" autocomplete="username"/>
                            </div>
                            <div class="6u 12u$(4)">
                                <input type="password" name="password" id="password" autocomplete="current-password" placeholder="비밀번호"/>
                            </div>
                            <div class="6u$ 12u$(4)">
                                <input type="password" name="password_confirm" autocomplete="new-password" id="password_confirm" placeholder="비밀번호 확인"/>
                            </div>
                            <div class="6u$ 12u$(4)">
                                <input type="text" name="phone" id="phone" value="" placeholder="연락처(-를 빼고 적어주세요.)"/>
                            </div>
                            <div class="4u 12u$(3)">
                    ...
                    <h3>수집 항목</h3>
                            <div class="12u$">
                                <div class="select-wrapper" >
                                    ...
                                    <select name="religion" id="category4">
                                        <option value="">- 선택 -</option>
                                    ...
                                    <select name="hobby" id="category5">
                                        <option value="">- 선택 -</option>
                                    ...
                                    <div class="4u 12u$(3)">
                                            <input type="radio" id="marry" name="marry" value="2" >
                                            <label for="marry">기혼</label>
                                    </div>
                                    <div class="4u 12u$(3)">
                                        <input type="radio" id="no-marry" name="marry" value="1">
